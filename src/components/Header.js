          ...
          <div className="flex items-center gap-2 md:gap-3 shrink-0 pointer-events-auto relative z-[10000]">
            ...
            {user ? (
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-[10005] whitespace-nowrap">
                    <div className="font-pixel text-[8px] md:text-[8.5px] px-2.5 py-1 bg-retro-black text-white border border-white/30 rounded-none shadow-[2px_2px_0px_0px_rgba(0,0,0,0.8)] flex items-center gap-1">
                      <span className="text-pixel-green">Peran:</span>
              ...
              <div className="flex items-center gap-1.5 shrink-0 pointer-events-auto relative z-[10000]">
                <Link
                  href="/login"
                  className="font-pixel text-[9px] md:text-[10px] px-3.5 py-1.5 border-2 border-retro-black hover:bg-navy-light transition-all rounded-full bg-navy-blue text-white pointer-events-auto cursor-pointer relative z-[10000] shadow-sm"
                >
                  {language === "ID" ? "MASUK" : "LOGIN"}
                </Link>
                <Link
                  href="/register"
                  className="font-pixel text-[9px] md:text-[10px] px-3.5 py-1.5 border-2 border-retro-black hover:bg-pixel-green-dark transition-all rounded-full bg-pixel-green text-retro-black font-bold pointer-events-auto cursor-pointer relative z-[10000] shadow-sm"
                >
